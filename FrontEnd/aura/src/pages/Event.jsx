  ...
  return (
    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 transition-colors duration-200">
      ...
      <main className="container mx-auto px-4 py-8">
        {/* My Events Section */}
        <div className="min-h-[400px] bg-gray-100 dark:bg-gray-900">
        ...
        <section id="events" className="mb-12">
          ...
          {/* Upcoming Events */}
          <div className="min-h-[400px] bg-gray-100 dark:bg-gray-900">
            <h2 className="text-3xl font-bold mb-4 dark:text-white">Upcoming Events</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          {/* Past Events */}
          <div className="min-h-[400px] bg-gray-100 dark:bg-gray-900">
            <h2 className="text-3xl font-bold mb-4 dark:text-white">Past Events</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
